            ...
            <AlertDialogContent className="bg-[#0f172a] border-white/10 text-white">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-slate-400">
                        This action is permanent and will remove this collection from your storefront. Any products associated specifically with this category may need re-assigning.
                    </AlertDialogDescription>
                </AlertDialogHeader>
