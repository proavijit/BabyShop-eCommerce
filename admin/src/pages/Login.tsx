                ...
                <Card className="bg-[#1e293b]/50 backdrop-blur-xl border-white/10 shadow-2xl">
                    <CardHeader className="flex flex-col items-center space-y-4">
                        ...
                        <div className="text-center">
                            <CardTitle className="text-2xl font-bold text-white">BabyMart Admin</CardTitle>
                            <CardDescription className="text-slate-400">Sign in to manage your store</CardDescription>
                        </div>
                    </CardHeader>
