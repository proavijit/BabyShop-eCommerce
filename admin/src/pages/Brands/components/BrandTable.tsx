        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-slate-400 text-sm">Manage your product brands and logos</p>
                </div>
                <Button
                    onClick={onAddBrand}
                    ...
                    <Table>
                        <TableHeader className="bg-white/5">
                            <TableRow className="border-b border-white/10 hover:bg-transparent">
                                <TableHead className="px-6 py-4 text-slate-400 font-bold uppercase text-[10px] tracking-widest w-[80px]">Logo</TableHead>
                                <TableHead className="px-6 py-4 text-slate-400 font-bold uppercase text-[10px] tracking-widest">Brand Name</TableHead>
